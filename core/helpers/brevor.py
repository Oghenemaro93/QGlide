...
class BervorApi:
    ...
    @classmethod
    def verified_user_email(cls, recipient:str, name:str):
        verify_email_content = """
        <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
        <html xmlns="http://www.w3.org/1999/xhtml">
        <head>
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
            ...
            <td align="center" style="padding: 20px 0;">
                ...
                <tr>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        ...
                        <td style="color: #153643; font-family: sans-serif; font-size: 16px; line-height: 24px; padding-bottom: 20px;">
                            Hi [Recipient Name],
                            <br/><br/>
                            Your onboarding is now complete, You can now login
                        </td>
                        </tr>
                    </table>
                    </td>
                ...
                <tr>
                    <td bgcolor="#ee4c50" style="padding: 30px 30px 30px 30px; text-align: center;">
                    <span style="color: #ffffff; font-family: sans-serif; font-size: 14px;">&reg; Qglide, 2025</span>
                    </td>
                </tr>
                </table>
            </td>
